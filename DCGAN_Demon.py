...
def generate_and_save_images(model, epoch, test_input):
  ...
  if not os.path.exists('./mnist/result/') :
      os.makedirs("./mnist/result/")
  plt.savefig('./mnist/result/image_at_epoch_{:04d}.png'.format(epoch))
#   plt.show()
  

def train(dataset, epochs, noise_dim):  
  for epoch in range(epochs):
    os.environ['CUDA_VISIBLE_DEVICES'] = '-1' #add to see whether CPU affects the running time or not
    start = time.time()
...
#with imageio.get_writer('./mnist/result/dcgan.gif', mode='I') as writer:
#  filenames = glob.glob('./mnist/result/image*.png')
...
#os.system('cp ./result/dcgan.gif ./result/dcgan.gif.png')

#display.Image(filename="result.dcgan.gif.png")
